...
- (void)setupUI
{
    ...
    [self.headerView setPreviousMonthClick:^(NSDate *date) {
        ...
        [weakSelf didSelectHeaderView:date];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        [cell reloadSubtitleColorWithColor:[self subtitleColorForDate:date]];
...
- (UIColor *)subtitleColorForDate:(NSDate *)date
{
    if (_dataSource && [_dataSource respondsToSelector:@selector(calendar:subtitleColorForDate:)]) {
        return [_dataSource calendar:self subtitleColorForDate:date];
    }
    return kColorMajor;
}
...
- (void)didSelectHeaderView:(NSDate *)date {
    if (_delegate && [_delegate respondsToSelector:@selector(calendar:didSelectHeaderView:)]) {
        [_delegate calendar:self didSelectHeaderView:date];
    }
}
